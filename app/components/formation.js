...
export default function Formation() {
  return (
    <section className="w-full flex md:flex-row flex-col md:gap-0 gap-10 md:h-screen md:p-10 md:pr-20 p-5 md:my-0 my-10" id="formation">
      <section className="md:w-1/2 flex flex-col items-start justify-center gap-2">
        ...
        <p className="mt-10 md:text-base text-sm" style={{ textWrap: "balance" }}>
