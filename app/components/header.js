...
export default function Header() {
    ...
    <section className="md:w-1/2 flex flex-col items-start justify-center gap-2 md:p-20 p-5">
      <h1 className="md:text-7xl text-4xl">Hi There</h1>
      <h2 className="md:text-6xl text-3xl tracking-wider">
        Im <tag className="text-violet-800 font-bold">Esteban</tag>
      </h2>
      <h4 className="md:text-xl bg-violet-800 p-1 text-white">
        Full stack developer
      </h4>
      <p className="md:mt-10 mt-5 md:line-clamp-none line-clamp-3" style={{textWrap: 'balance'}}>
      ...
      <a className=" p-2 bg-violet-800 rounded-3xl text-white mt-1 hover:bg-violet-600 transition-all duration-500" href='/#contact'>Connect whit me</a>
    </section>
