  ...
  return (
    ...
    >
      <h1 className="md:text-6xl text-5xl font-normal md:text-right text-center">
        {traslation.Title1}{" "}
        <tag className="text-blue-700 font-bold">{traslation.Title2}</tag>
      </h1>
      <div className="flex md:flex-row flex-col w-full justify-around mt-16">
        <section className="md:w-1/4">
          <div className="flex flex-col gap-10">
            ...
            >
              <div className="bg-slate-100 h-full p-4">
                <AiOutlineLinkedin className=" text-5xl group-hover:text-blue-600 transition-all duration-200" />
              </div>
              <div>
          ...
          >
            <label className="flex flex-col md:text-lg text-base font-bold gap-1">
              ...
              <input
                ...
                name="nombre"
                type="text"
                className="bg-slate-100 outline-none py-1 focus-visible:bg-slate-50 focus-visible:outline-2 focus-visible:outline-blue-700 pl-2"
              />
            </label>
            <label className="flex flex-col md:text-lg text-base font-bold gap-1">
              Email
            ...
            {!sended ? (
              <button
                type="submit"
                className="bg-blue-700 text-white w-20 p-2 self-end rounded-3xl hover:bg-blue-600 transition-all duration-200"
              >
                {traslation.Send}
              </button>
            ) : (
              <div className="self-end ">
                <AiFillCheckCircle className=" text-5xl text-blue-700 " />
              </div>
            )}
          </form>
        </section>
