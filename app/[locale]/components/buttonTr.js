  ...
  return (
    <div className="dropdown text-black fixed md:right-5 top-3 right-2 md:top-24 w-11 rounded-3xl z-20 ">
      ...
      <div className="dropdown-menu md:dropdown-menu-left dropdown-menu-left-bottom w-20 flex bg-white border border-gray-10">
        <a className="dropdown-item text-sm flex items-center hover:bg-gray-50 hover:text-violet-800  hover:scale-105 transition-all duration-200">
          {" "}
        ...
        <a
          tabIndex="-1"
          className="dropdown-item text-sm items-center hover:bg-gray-50 hover:text-violet-800  hover:scale-105 transition-all duration-200"
        >
