  ...
  return (
    ...
    >
      ...
      <Link href="https://movies-b3476.web.app/" className="flex flex-col items-center gap-4 pt-2 group bg-slate-100 hover:bg-slate-50 hover:scale-105 hover:-translate-y-1  transition-all duration-200">
        <h2 className="text-lg font-bold group-hover:text-violet-800 transition-all duration-200">Movies App</h2>
        ...
        <Link href="https://weatherkorn.web.app/" className="flex flex-col items-center gap-4 pt-2 group bg-slate-100 hover:bg-slate-50 hover:scale-105 hover:-translate-y-1  transition-all duration-200">
          <h2 className="text-lg font-bold group-hover:text-violet-800 transition-all duration-200">Weather App</h2>
        ...
        <Link href="https://summoners-handbook.netlify.app/" className="flex flex-col items-center gap-4 pt-2 group bg-slate-100 hover:bg-slate-50 hover:scale-105 hover:-translate-y-1  transition-all duration-200">
          <h2 className="text-lg font-bold group-hover:text-violet-800 transition-all duration-200">Summoners Handbook</h2>
        ...
        <h2 className="text-lg font-bold group-hover:text-violet-800 transition-all duration-200">Roma Studio</h2>
        ...
        <Link href="https://palabradehoy.vercel.app/" className="flex flex-col items-center gap-4 pt-2 group bg-slate-100 hover:bg-slate-50 hover:scale-105 hover:-translate-y-1  transition-all duration-200">
